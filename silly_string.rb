...
puts "My favorite word is #{debugger}"
...
puts "MY FAVORITE WORD IS #{supercalifragilisticexpialidocious}".upcase

# Challenge 3: Make all the letters of phrase lowercase using a built in Ruby method

phrase = "IM NOT SHOUTING".lowercased_phrase
...
big_word = "supercalifragilisticexpialidocious".letter_count
...
proper_sentence = "i really like programming.".proper_sentence # Put a . after the string to capitalize it properly.
...
sentence = sentence # Add your gsub.sentence chain here
